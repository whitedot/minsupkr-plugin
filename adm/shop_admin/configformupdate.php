...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$_POST['de_admin_company_owner']}',
                ...
                de_tag_skin              = '{$_POST['de_tag_skin']}',
                de_tag_mod               = '{$_POST['de_tag_mod']}',
                de_tag_row               = '{$_POST['de_tag_row']}',
                de_tag_width              = '{$_POST['de_tag_width']}',
                de_tag_height             = '{$_POST['de_tag_height']}',
                de_tag_mobile_skin              = '{$_POST['de_tag_mobile_skin']}',
                de_tag_mobile_mod               = '{$_POST['de_tag_mobile_mod']}',
                de_tag_mobile_row               = '{$_POST['de_tag_mobile_row']}',
                de_tag_mobile_width              = '{$_POST['de_tag_mobile_width']}',
                de_tag_mobile_height             = '{$_POST['de_tag_mobile_height']}',
                de_tag_pc               = '{$_POST['de_tag_pc']}',
                de_tag_mobile               = '{$_POST['de_tag_mobile']}',
